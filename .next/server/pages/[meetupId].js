...
/* harmony default export */ var meetups_MeetDetail = (MeetDetail);
...
function MeetupDetails(props) {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    ...
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(meetups_MeetDetail, {
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://test:xjWQpPBWUcJtVEbu@cluster0.fj6g3.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
